...
const DATA_SOURCES = {
  twelve_data: {
    ...
    notes:
      "Grow-plan-only endpoints (price_target, profile) are probed monthly and not used live for target. market_movers is paid-tier — not used. Board refresh batches /time_series multi-symbol (HTTP); credits remain 1/symbol.",
  },
  fmp: {
    id: "fmp",
    ...
    priority: { discovery: 1 },
    notes:
      "Free-tier biggest-gainers / biggest-losers / most-actives via /stable/*. Confirmed live on free plan.",
    legendDetail: "Financial Modeling Prep (discovery movers)",
  },
  alpha_vantage: {
    id: "alpha_vantage",
    label: "Alpha Vantage",
